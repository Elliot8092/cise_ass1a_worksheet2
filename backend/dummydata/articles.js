const articles = [
    {
        _id: "1",
        title: "An experimental ecaluation of test driven development vs. test-last development with industry professionals",
        authors: "Munir, H., Wnukm K., Petersen, K., Moayyed, M.",
        source: "EASE",
        pubyear: "2014",
        doi: "https://doi.org/10.1145/2601248.2601267",
        claim_evidence: [["code improvment", "strong support"], ["product improvement", "weak against"],
    ["team improvment", "none"]],
    },
    {
        _id: "2",
